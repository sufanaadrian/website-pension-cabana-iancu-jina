...
export default function Footer() {
  ...
  const sectionCls = isNature ? "text-white/60 py-12 border-t-2" : "bg-gray-900 text-gray-400 py-12 border-t-2";
  const sectionStyle = isNature ? { backgroundColor: getNatureAccentColor() } : undefined;
